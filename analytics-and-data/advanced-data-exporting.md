...
{% hint style="info" %}
Prive offers advanced data exports in both the “Subscription Contracts” tab and the “Settings” tab of the Prive app. These exports depict all subscriber data from names, emails, billing and shipping addresses, frequencies, next order dates, and more.
{% endhint %}

## Reports Available for Export Overview

Navigate to "Settings" in the side navigation of your Prive admin account. Scroll to the bottom of the settings page to see reports available for export.&#x20;
...
* Contains a list of orders that were placed through the Prive system.
